...
import { Author } from "@packages/types/web/blog";
...
const AuthorSignature: React.FC<AuthorSignatureProps> = ({ author, date, className = "" }) => (
    <div className={`post-author__meta ${className}`.trim()}>
        ...
        <div className="avatar">
            <img src={ava} alt={`Avatar de ${author.name}`} className="av  shadow" />
