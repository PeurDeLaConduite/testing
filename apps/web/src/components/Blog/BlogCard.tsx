...
function BlogCard({ post, author, hovered, faded, onHover, onUnhover, onFocus, onBlur }: Props) {
    ...
    return (
        <article
            className={`blog-card${hovered ? " cardHovered" : ""}${faded ? " cardFaded" : ""}`}
            ...
            <div className="blog-card__header">
                ...
                <div className="blog-card__footer">
                    <div className="blog-card__link">
                        <ButtonLink href={`/blog/${post.slug}`}>Lire l&apos;article</ButtonLink>
                    </div>
