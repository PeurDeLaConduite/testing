...
const SiteEditorCreator = () => {
    return (
        <section className="pp">
            <h3 className="pp_section-tle">🛠️ Webmaster / Création et maintenance</h3>
            <p>
                <strong>Nom :</strong> Jérémy Maxime Claude Lemaignent
            </p>
            <p>
                <strong>Statut :</strong> Entrepreneur individuel (Micro-entrepreneur)
            </p>
            <p>
            ...
            <p>
                <strong>Adresse :</strong> 69 rue Maurice Tronele, 76620 Le Havre, France
            </p>
            <p>
...
export default SiteEditorCreator;
