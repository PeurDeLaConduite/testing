import { ContactAnnouncement, ContactDetail, SocialLink } from "../interfaces/content";

export const contactAnnouncements: ContactAnnouncement[] = [
    {
        message: "Besoin de conseils ou de renseignements ? N'hésite pas à me contacter.",
    },
