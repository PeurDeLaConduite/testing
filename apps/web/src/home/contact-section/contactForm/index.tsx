...
const ContactForm = () => {
    ...
    const validateFields = (): boolean => {
        let newErrors: Errors = {
            ...
            telephone: formData.telephone ? validatePhoneNumber(formData.telephone) : "",
    ...
    return (
        <form className="ctc-form" method="POST" onSubmit={handleSubmit} id="ctc-form">
            <ContactFormTitle />
            <ContactQuestions />
            <Form formData={formData} errors={errors} handleChange={handleChange} state={state} />
            <FormSuite
                formData={formData}
                errors={errors}
            ...
            <div className="endOF">
                <button type="submit" className="btn-style_blue flx-c" disabled={state.submitting}>
