        ...
        <div className={`slider-number ${SlideClass}`}>
            ...
            >
                ...
                <g className="sld-numb1">
                    ...
                    <use href="#I" x="12" y="105" fill="url(#F)" className="Q" />
                    <use href="#J" x="12" y="105" className="S" />
                    <text transform="matrix(1.0616 0 0 1 644 382)" className="T U">
                        1
                    </text>
                </g>
                <g className="sld-numb2">
                    <use href="#H" x="125.6" y="-78" className="P" />
                    <use href="#I" x="125.7" y="-78" fill="url(#F)" className="Q" />
                ...
                <g className="sld-numb3">
                    ...
                    <use href="#I" x="348" y="57.5" fill="url(#F)" className="Q" />
                    <use href="#J" x="348" y="57.5" className="S" />
                    <text transform="matrix(1.0616 0 0 1 980 334)" className="T U">
                        3
                    </text>
                </g>
                <g className="sld-numb4">
                    <use href="#H" x="483" y="-28.5" className="P" />
                    <use href="#I" x="483" y="-28.5" fill="url(#F)" className="Q" />
                    <use href="#J" x="483" y="-28.5" className="S" />
                    <text transform="matrix(1.0616 0 0 1 1114.5 249.5)" className="T U">
                        4
                    </text>
                </g>
                <g className="sld-numb5">
                    <use href="#H" x="637" y="127" className="P" />
                    <use href="#I" x="637" y="127" fill="url(#F)" className="Q" />
                    <use href="#J" x="637" y="127" className="S" />
                    <text transform="matrix(1.0616 0 0 1 1270 404)" className="T U">
                        5
                    </text>
                </g>
                ...
                <defs>
                    ...
                    />
                    <path id="I" d="M640.1 248.7c17.3 0 34.6 19.1 1.2 53.4-.4.4-.7.6-1.2.6v-54z" />
                    <path
                        id="J"
