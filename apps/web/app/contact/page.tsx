...
export const metadata: Metadata = {
    ...
    alternates: {
        ...
        media: {
            "only screen and (max-width: 900px)": "https://mobile.peur-de-la-conduite.fr/contact",
            "only screen and (min-width: 900px)": "https://desktop.peur-de-la-conduite.fr/contact",
        },
    },
    robots: {
        index: true,
